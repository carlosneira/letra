...
function emailFormSubmission()
{
	...
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Nome e apelidos:</b></td><td>' . htmlentities($_REQUEST["custom_U1250"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Correo electrónico:</b></td><td>' . htmlentities($_REQUEST["Email"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
	$message .= '<tr><td valign="top" style="background-color: #ffffff;"><b>Mensaxe:</b></td><td>' . htmlentities($_REQUEST["custom_U1235"],ENT_COMPAT | ENT_HTML401,'UTF-8') . '</td></tr>';
